#[proc_macro]
pub fn user_port_try_from_u16(possible_u16_token_stream: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let valid_port_token_stream = valid_port
        ...
        .unwrap_or_else(|_| panic!("failed to parse valid u16 user port to proc_macro2::TokenStream"));
    let gen = quote::quote! {
